			...
			<c:forEach var="act" items="${Act}" varStatus="st">
				<div class="Main_Box">
					<div class="C_Box">
						...
						<div class="T_Box">
<%-- 							<c:out value="${act.dos_id.DOS_ID}" /> --%>
							<c:out value="${act.ACT_DESC}" />
						</div>
						<div class="Con_Box">
							<table>
								<tr>
<!-- 									<td style="width: 150px;">比賽縣市:</td> -->
									<td style="width: 150px;">比賽場地:${act.dos_id.DOS_NAME}</td>
		...
		<div class="master">
			<div style="text-align: center; margin-bottom: 150px;">
				<a href="?start=0">[首頁]</a> <a href="?start=${pre}" class="pages">上一頁</a>
				<a href="?start=${next}" class="pages">下一頁</a> <a
					href="?start=${last}">[最後一頁]</a>
			</div>
		</div>
	</div>

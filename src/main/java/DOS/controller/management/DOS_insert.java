 ...
 */
@WebServlet("/DOS/DOS_insert")
public class DOS_insert extends HttpServlet {
	...
	private void insertDOS(HttpServletRequest request, HttpServletResponse response)
		 ...
		 DOS dos1=new DOS(null, dosName,dosAddr, 0,0, dosCy, 100, "xxx", "xxx", "xxx",dosTRANS1,dosPS1,null,dos_sport);
	     rs.insertid(dos1);
